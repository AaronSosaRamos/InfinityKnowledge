...
BEGIN
    ...
    DECLARE c1 cursor FOR SELECT registro_asistencias.estudiante_id,registro_asistencias.docente_id,registro_asistencias.curso_id,registro_asistencias.salon_clases_id
    ...
    AND registro_asistencias.docente_id = docente_id_ AND registro_asistencias.curso_id = curso_id_ AND registro_asistencias.salon_clases_id  = salon_clases_id_; 
