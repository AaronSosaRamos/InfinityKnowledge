...
BEGIN
    SELECT grado_academico.grado_academico_id, grado_academico.nombre FROM infinite_knowledge.grado_academico WHERE
    grado_academico.grado_academico_id = grado_academico_id_ ORDER BY grado_academico.grado_academico_id ASC; 
END //
DELIMITER ;
...
BEGIN
    SELECT grado_academico.grado_academico_id, grado_academico.nombre  FROM infinite_knowledge.grado_academico WHERE grado_academico.nombre LIKE nombre_ 
    ORDER BY grado_academico.grado_academico_id ASC; 
END //
DELIMITER ;
