...
BEGIN
    SELECT especialidad_academica.especialidad_academica_id, especialidad_academica.nombre FROM infinite_knowledge.especialidad_academica
    ORDER BY especialidad_academica.especialidad_academica_id ASC; 
END //
DELIMITER ;
...
BEGIN
    SELECT especialidad_academica.especialidad_academica_id, especialidad_academica.nombre FROM infinite_knowledge.especialidad_academica WHERE 
    especialidad_academica.especialidad_academica_id = especialidad_academica_id_ ORDER BY especialidad_academica.especialidad_academica_id ASC; 
END //
DELIMITER ;
...
BEGIN
    SELECT especialidad_academica.especialidad_academica_id, especialidad_academica.nombre  FROM infinite_knowledge.especialidad_academica WHERE
    especialidad_academica.nombre LIKE nombre_ ORDER BY especialidad_academica.especialidad_academica_id ASC; 
END //
DELIMITER ;
...
BEGIN
    UPDATE infinite_knowledge.especialidad_academica SET especialidad_academica.nombre = nombre_ WHERE especialidad_academica.especialidad_academica_id = 
