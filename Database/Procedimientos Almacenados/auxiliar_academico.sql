...
BEGIN
    ...
    n_docentes_a_cargo,genero_id,numero_telefonico,grado_academico_id) VALUES (dni_,nombre_,apellido_paterno_,apellido_materno_,
    fecha_nacimiento_,n_docentes_a_cargo_,genero_id_,numero_telefonico_,grado_academico_id_); 
END //
DELIMITER ;
...
BEGIN
    ...
    auxiliar_academico.n_docentes_a_cargo,genero.nombre AS genero,auxiliar_academico.numero_telefonico,grado_academico.nombre 
    AS grado_academico FROM (infinite_knowledge.auxiliar_academico INNER JOIN infinite_knowledge.genero ON auxiliar_academico.genero_id 
    = genero.genero_id) INNER JOIN infinite_knowledge.grado_academico ON auxiliar_academico.grado_academico_id = grado_academico.grado_academico_id 
    WHERE auxiliar_academico.auxiliar_academico_id = auxiliar_academico_id_ ORDER BY auxiliar_academico.auxiliar_academico_id ASC; 
END //
DELIMITER ;
...
BEGIN
    SELECT auxiliar_academico.auxiliar_academico_id,auxiliar_academico.dni, CONCAT(auxiliar_academico.apellido_paterno,' '
    ,auxiliar_academico.apellido_materno,' ',auxiliar_academico.nombre) AS nombre_completo,auxiliar_academico.fecha_nacimiento,
    auxiliar_academico.n_docentes_a_cargo,genero.nombre AS genero,auxiliar_academico.numero_telefonico,grado_academico.nombre AS 
    grado_academico FROM (infinite_knowledge.auxiliar_academico INNER JOIN infinite_knowledge.genero ON auxiliar_academico.genero_id = genero.genero_id) 
    INNER JOIN infinite_knowledge.grado_academico ON auxiliar_academico.grado_academico_id = grado_academico.grado_academico_id 
    WHERE auxiliar_academico.dni = dni_ ORDER BY auxiliar_academico.auxiliar_academico_id ASC; 
END //
DELIMITER ;
...
BEGIN
    ...
    AS nombre_completo,auxiliar_academico.fecha_nacimiento,auxiliar_academico.n_docentes_a_cargo,genero.nombre 
    AS genero,auxiliar_academico.numero_telefonico,grado_academico.nombre AS grado_academico FROM (infinite_knowledge.auxiliar_academico 
    INNER JOIN infinite_knowledge.genero ON auxiliar_academico.genero_id = genero.genero_id) INNER JOIN infinite_knowledge.grado_academico 
    ON auxiliar_academico.grado_academico_id = grado_academico.grado_academico_id WHERE CONCAT(auxiliar_academico.apellido_paterno,' ',
    auxiliar_academico.apellido_materno,' ',auxiliar_academico.nombre) LIKE CONCAT('%',nombre_completo_,'%') ORDER BY auxiliar_academico.auxiliar_academico_id ASC; 
END //
DELIMITER ;
...
BEGIN
    ...
    ORDER BY auxiliar_academico.auxiliar_academico_id ASC; 
END //
DELIMITER ;
...
BEGIN
    ...
    AS nombre_completo FROM infinite_knowledge.auxiliar_academico WHERE auxiliar_academico.dni = dni_  ORDER BY auxiliar_academico.auxiliar_academico_id ASC; 
END //
DELIMITER ;
...
BEGIN
    SELECT auxiliar_academico.auxiliar_academico_id,auxiliar_academico.dni, 
    CONCAT(auxiliar_academico.apellido_paterno,' ',auxiliar_academico.apellido_materno,' ',auxiliar_academico.nombre) 
    AS nombre_completo,auxiliar_academico.fecha_nacimiento,auxiliar_academico.n_docentes_a_cargo,genero.nombre AS
    genero,auxiliar_academico.numero_telefonico,grado_academico.nombre AS grado_academico FROM (infinite_knowledge.auxiliar_academico
    INNER JOIN infinite_knowledge.genero ON auxiliar_academico.genero_id = genero.genero_id) INNER JOIN infinite_knowledge.grado_academico 
    ON auxiliar_academico.grado_academico_id = grado_academico.grado_academico_id WHERE auxiliar_academico.auxiliar_academico_id = LAST_INSERT_ID()
    ORDER BY auxiliar_academico.auxiliar_academico_id ASC; 
END //
DELIMITER ;
...
BEGIN
    ...
    = n_docentes_a_cargo_,auxiliar_academico.genero_id = genero_id_,auxiliar_academico.numero_telefonico = numero_telefonico_,auxiliar_academico.grado_academico_id = 
    grado_academico_id_ WHERE auxiliar_academico.auxiliar_academico_id = LAST_INSERT_ID();
END //
DELIMITER ;
