...
BEGIN
    SELECT estado_aprobacion.estado_aprobacion_id, estado_aprobacion.nombre FROM infinite_knowledge.estado_aprobacion WHERE estado_aprobacion.estado_aprobacion_id = estado_aprobacion_id_ ORDER BY estado_aprobacion.estado_aprobacion_id ASC; 
END //
DELIMITER ;
...
BEGIN
    SELECT estado_aprobacion.estado_aprobacion_id, estado_aprobacion.nombre  FROM infinite_knowledge.estado_aprobacion WHERE estado_aprobacion.nombre LIKE nombre_ ORDER BY estado_aprobacion.estado_aprobacion_id ASC; 
END //
DELIMITER ;
