...
BEGIN
    INSERT INTO infinite_knowledge.estudiante(dni,nombre,apellido_paterno,apellido_materno,fecha_nacimiento,genero_id,numero_telefonico) VALUES 
    (dni_,nombre_,apellido_paterno_,apellido_materno_,fecha_nacimiento_,genero_id_,numero_telefonico_); 
END //
DELIMITER ;
...
BEGIN
    ...
    nombre_completo, estudiante.fecha_nacimiento, genero.nombre as genero, estudiante.numero_telefonico FROM infinite_knowledge.estudiante INNER JOIN 
    infinite_knowledge.genero ON estudiante.genero_id = genero.genero_id WHERE estudiante.estudiante_id = estudiante_id_ ORDER BY estudiante.estudiante_id ASC; 
END //
DELIMITER ;
...
BEGIN
    SELECT estudiante.estudiante_id,estudiante.dni,CONCAT(estudiante.apellido_paterno,' ',estudiante.apellido_materno,' ',estudiante.nombre) AS 
    nombre_completo, estudiante.fecha_nacimiento, genero.nombre as genero, estudiante.numero_telefonico FROM infinite_knowledge.estudiante INNER JOIN 
    infinite_knowledge.genero ON estudiante.genero_id = genero.genero_id WHERE estudiante.dni = dni_ ORDER BY estudiante.estudiante_id ASC; 
END //
DELIMITER ;
...
BEGIN
    SELECT estudiante.estudiante_id,estudiante.dni,CONCAT(estudiante.apellido_paterno,' ',estudiante.apellido_materno,' ',estudiante.nombre) AS 
    nombre_completo, estudiante.fecha_nacimiento, genero.nombre as genero, estudiante.numero_telefonico FROM infinite_knowledge.estudiante INNER JOIN 
    infinite_knowledge.genero ON estudiante.genero_id = genero.genero_id WHERE CONCAT(estudiante.apellido_paterno,' ',estudiante.apellido_materno,' ',estudiante.nombre) 
...
BEGIN
    ...
    estudiante.dni = dni_ ORDER BY estudiante.estudiante_id ASC; 
END //
DELIMITER ;
...
BEGIN
    SELECT estudiante.estudiante_id,estudiante.dni,CONCAT(estudiante.apellido_paterno,' ',estudiante.apellido_materno,' ',estudiante.nombre) AS nombre_completo, 
    estudiante.fecha_nacimiento, genero.nombre as genero, estudiante.numero_telefonico FROM infinite_knowledge.estudiante INNER JOIN infinite_knowledge.genero ON 
    estudiante.genero_id = genero.genero_id ORDER BY estudiante.estudiante_id ASC; 
END //
DELIMITER ;
...
BEGIN
    ...
    apellido_materno_,estudiante.fecha_nacimiento=fecha_nacimiento_,estudiante.genero_id=genero_id_,estudiante.numero_telefonico=numero_telefonico_ WHERE 
