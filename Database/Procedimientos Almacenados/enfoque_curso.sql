...
BEGIN
    SELECT enfoque_curso.enfoque_curso_id, enfoque_curso.nombre FROM infinite_knowledge.enfoque_curso WHERE enfoque_curso.enfoque_curso_id = enfoque_curso_id_ 
    ORDER BY enfoque_curso.enfoque_curso_id ASC; 
END //
DELIMITER ;
...
BEGIN
    SELECT enfoque_curso.enfoque_curso_id, enfoque_curso.nombre  FROM infinite_knowledge.enfoque_curso WHERE enfoque_curso.nombre LIKE nombre_ ORDER BY
    enfoque_curso.enfoque_curso_id ASC; 
END //
DELIMITER ;
