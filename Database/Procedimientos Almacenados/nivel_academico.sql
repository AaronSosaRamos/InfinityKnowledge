...
BEGIN
    SELECT nivel_academico.nivel_academico_id, nivel_academico.nombre FROM infinite_knowledge.nivel_academico WHERE nivel_academico.nivel_academico_id = nivel_academico_id_ ORDER BY nivel_academico.nivel_academico_id ASC; 
END //
DELIMITER ;
...
BEGIN
    SELECT nivel_academico.nivel_academico_id, nivel_academico.nombre  FROM infinite_knowledge.nivel_academico WHERE nivel_academico.nombre LIKE nombre_ ORDER BY nivel_academico.nivel_academico_id ASC; 
END //
DELIMITER ;
