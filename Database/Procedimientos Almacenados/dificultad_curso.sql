...
BEGIN
    SELECT dificultad_curso.dificultad_curso_id, dificultad_curso.nombre FROM infinite_knowledge.dificultad_curso WHERE dificultad_curso.dificultad_curso_id = dificultad_curso_id_ ORDER BY dificultad_curso.dificultad_curso_id ASC; 
END //
DELIMITER ;
...
BEGIN
    SELECT dificultad_curso.dificultad_curso_id, dificultad_curso.nombre  FROM infinite_knowledge.dificultad_curso WHERE dificultad_curso.nombre LIKE nombre_ ORDER BY dificultad_curso.dificultad_curso_id ASC; 
END //
DELIMITER ;
